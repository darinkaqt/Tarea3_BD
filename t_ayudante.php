  ...
  <div class="row">
    <div class="col-sm-2">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="t_ayudante.php">Ayudantes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="t_profesor.php">Profesores</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="t_misionestot.php">Misiones</a>
        </li>
        <li class="nav-item">
    ...
    <div class="col-sm-8">
      ...
      if( pg_num_rows($result) > 0 ) {
        while($row = pg_fetch_assoc($result)) {
          echo "<tr><td>" . $row["rolayudante"]. "</td><td>" . $row["nombre"] . "</td><td>". $row["apellido"]. "</td><td>". $row["cantidadsemestres"]. "</td></tr>";
        }
        echo "</table>";
        pg_close($dbconn);
      }
