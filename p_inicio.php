  ...
  <div class="row">
    <div class="col-sm-2">
      ...
      <ul class="nav nav-pills flex-column">
        <li class="nav-item">
          <a class="nav-link" href="Estudiante\s_estudiante.php?flag_alumno=0">Estudiante</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="p_estudiante.php?flag_alumno=0">Profesor</a>
        </li>
      </ul>
      <br>
      <br>
      ...
      <ul class="nav nav-pills flex-column">
        <li class="nav-item">
          <a class="nav-link" href="Estudiante\r_estudiante.php?flag_alumno=0">Estudiante</a>
        </li>
      </ul>
      <hr class="d-sm-none">
    </div>
